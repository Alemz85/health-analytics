...
describe('Insights inference policy', () => {
  ...
  it('surfaces the expanded daily and workout-context inference contracts', () => {
    ...
    expect(source).toMatch(/key: 'daily'[\s\S]*?expectedVersion: 9/)
    expect(source).toMatch(/key: 'workout'[\s\S]*?expectedVersion: 14/)
    ...
    expect(source).toContain("correlation.var_x === 'sleep_midpoint_shift'")
  })
})
