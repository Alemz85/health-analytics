...
describe('Insights inference policy', () => {
  ...
  it('surfaces the expanded daily and workout-context inference contracts', () => {
    ...
    expect(source).toMatch(/key: 'daily'[\s\S]*?expectedVersion: 8/)
    expect(source).toMatch(/key: 'workout'[\s\S]*?expectedVersion: 13/)
    ...
    expect(source).toContain("correlation.var_x === 'training_density_7d_prior'")
  })
})
