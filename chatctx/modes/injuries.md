...
python3 injuries.py plan-add <injury_id> --name ".." [--kind exercise|habit|constraint|activity] [--target 1-14] [--note ".."] [--exercise "<catalog name>"]
python3 injuries.py plan-update <item_id> [--name ".."] [--kind ..] [--target 1-14|none] [--note ".."] [--active true|false] [--exercise "<catalog name>"|none]
